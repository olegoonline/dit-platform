...
export default function ReserveModal({
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    if (!variantId) { setError("Pick a program length"); return }
    ...
    try {
      ...
      if (!res.ok || !json.success) { setError(json.error ?? "Could not start reservation"); return }
      const leadParams = {
        program_id: programId,
            ...
            <form onSubmit={onSubmit} style={{ display: "grid", gap: 12 }}>
              ...
              <label>
                ...
                >
                  ...
                  {!loadingVariants && variants.length === 0 && <option value="">No pricing available</option>}
                  {variants.map((v) => (
              ...
              {selectedVariant && fullPrice != null && depositAmount != null && remainingBalance != null && (
                <div
                  style={{
                    display: "grid",
                    gap: 6,
